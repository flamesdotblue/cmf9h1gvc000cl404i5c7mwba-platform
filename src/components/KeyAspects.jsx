export default function KeyAspects() {
  return (
    <section id="benefits" className="relative mt-16 rounded-3xl overflow-hidden border border-white/10">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top_left,rgba(251,191,36,0.10),transparent_60%),radial-gradient(ellipse_at_bottom_right,rgba(168,85,247,0.10),transparent_60%)]" />
      <div className="max-w-7xl mx-auto px-6 py-12 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <ul className="mt-4 space-y-3 text-white/85 list-disc pl-5">
            ...
            <li>50+ Hiring Partners: top product-based companies & recruiters actively hiring from participants.</li>

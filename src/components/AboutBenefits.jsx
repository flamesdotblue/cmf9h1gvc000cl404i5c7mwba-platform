    ...
    <section id="about" className="relative py-20 border-t border-white/10 bg-[radial-gradient(ellipse_at_top,rgba(99,102,241,0.12),transparent_60%),radial-gradient(ellipse_at_bottom_right,rgba(168,85,247,0.12),transparent_60%)]">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12">
        <div>
          ...
          <div className="mt-8">
            <button onClick={onRegister} className="rounded-full bg-white text-black font-medium px-6 py-3 hover:bg-zinc-100">Register for Workshop</button>
          </div>
        </div>
        <div id="benefits" className="lg:pl-10">
          ...
          <ul className="mt-4 space-y-3 text-white/80 list-disc pl-5">
            ...
            <li>50+ Hiring Partners: top product-based companies & recruiters who will actively hire from the participants.</li>
            <li>Purely skill-based hiring: NO resume shortlisting — perform & get hired.</li>
            <li>1:1 Mentorship from IIIT‑H alumni from FAANG.</li>
            <li>Feedback & continued support: detailed performance feedback and how to improve.</li>
          </ul>
          <div className="mt-8 aspect-[4/3] rounded-2xl overflow-hidden border border-white/10 bg-[url('https://d1lrk9cp1c3gxw.cloudfront.net/media/public/auht/sarigamamentor_5Irt7qj.png')] bg-cover bg-center" />
        </div>
      </div>
    </section>
  );
